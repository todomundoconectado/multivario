...
export function LpHero() {
    return (
        <header className="relative min-h-[100svh] flex flex-col overflow-hidden bg-background-dark pt-32 sm:pt-36 md:pt-40 lg:pt-0">
            ...
            <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-8 mb-12 sm:mt-12 md:mt-16 lg:my-auto lg:pb-0">
